    ...
    <div className="min-h-screen bg-base-color flex">
      ...
      <div className="hidden lg:flex w-1/2 bg-teal-600 dark:bg-teal-800 relative overflow-hidden flex-col justify-between p-12">
        ...
        <div className="relative">
          ...
          <h2 className="text-white text-4xl font-bold leading-tight mb-4">Making impact measurable, one task at a time.</h2>
          <p className="text-teal-100 text-lg leading-relaxed">Connect your skills with communities that need them most.</p>
        </div>
